        ...
        try:
            ...
            if assistant_message.tool_calls:
                ...
                if _tool_turn_persisted is False:
                    ...
                    # Pair every still-undispatched call before the finalizer
                    # retries persistence. Otherwise that recovery write can
                    # durably land the assistant tool-call row by itself and
                    # leave a provider-invalid transcript on resume.
            ...
            if (
                ...
                if _is_code_skew_attribute_error:
                    ...
                    # This is a terminal process-integrity failure, not a
                    # successfully completed turn.  Keep the result contract
                    # aligned with the pre-iteration skew guard above.
                    failed = True
                elif _is_local_processing_error:
